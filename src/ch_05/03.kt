...
//    mutableSet.remove(1) //
    ...
    println(mutableSet.remove(10)) // false
    ...
    // 값이 있는지 없는지 여부 조사2 -> 반환값으로 인덱스값 반환 없으면 -1
    println(mutableSet.indexOf(1)) // -1
    println(mutableSet.indexOf(2)) // 0
    println(mutableSet.indexOf(100)) // 2
    println(mutableSet.indexOf(101)) // 3
